...
# Iterate over range for training and test size
for i in np.arange(0.25, 4.75, 0.25):
    ...
    test_ratio = i  # range 0.25-4.5 increments of .25
    ...
    with open('tests_6.csv', 'a', newline="") as f:
        writer = csv.writer(f)
        writer.writerow([
            model, good_features, smell_thr_per_hour, smell_predict_hrs, look_back_hrs, train_size,
